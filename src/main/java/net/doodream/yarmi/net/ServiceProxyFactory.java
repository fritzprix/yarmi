 ...
 *  {@link ServiceProxy}인스턴스를 반복적으로 생성하는 역알을 수행하기 때문에 {@link RMIServiceInfo}에는
...
public interface ServiceProxyFactory {
    /**
     * build {@link ServiceProxy} to remote service adapter would be comprised of below
     * 1. create {@link RMISocket} on which {@link ServiceProxy} depend
     * @return
     * @throws IOException
     */
    ServiceProxy build();
